  ...
  <div className="row" id="mainRow">
        ...
        <div id="mySidenav" className="sidenav" style={this.state.mySideNavStyle}>
          ...
          <div>
            ...
            <hr />
            <input role="button" className="btn btn-info"  type = 'reset' value = 'Clear' onChange={this.getBlogInfo}/>
            <input role="button" className="btn btn-primary"  type = 'submit' value = 'Filter' />
            <hr/>
                </form>          
          </div>
      </div>
